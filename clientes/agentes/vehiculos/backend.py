"""Acceso de `vehiculos` (clientes) a las BACKEND APIS.
...
LÍMITE DE ESTE BACKEND — no es una omisión, es la frontera:
    NO mapea propietario registral — es dato personal de un tercero, este backend NO lo mapea
    NO mapea partidas registrales
